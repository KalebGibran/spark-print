...
// Keep same pricing as backend (sementara)
...
export default function KioskPage() {
  ...
  >({ kind: "info", text: "Masukkan link/token FotoShare, pilih ukuran & jumlah, lalu bayar QRIS." });
  ...
  async function pay() {
    ...
    try {
      ...
      window.snap.pay(j.snap_token, {
        gopayMode: "qr",
        onSuccess: () => {
          // Catatan: status PAID yang valid tetap dari webhook (server)
          setStatus({ kind: "ok", text: "Pembayaran sukses. Silakan tunjukkan ke operator / tunggu diproses." });
        },
            ...
            <section className="lg:col-span-3">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-6">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h2 className="text-lg font-semibold">Input FotoShare</h2>
                    <p className="mt-1 text-sm text-zinc-400">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-zinc-950/30 p-4">
                    ...
                    <div className="mt-3 flex items-center justify-between gap-3">
                      <button
                        type="button"
                        onClick={() => bumpQty(-1)}
                        className="h-14 w-14 rounded-2xl border border-white/10 bg-white/5 text-2xl hover:bg-white/10 active:scale-[0.99]"
            ...
            <aside className="lg:col-span-2">
              ...
              <div className="mt-4 rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-6">
                ...
                <ul className="mt-3 space-y-2 text-sm text-zinc-300">
                  <li className="rounded-2xl border border-white/10 bg-zinc-950/30 p-3">
                    Gunakan monitor touch, zoom browser 100%, fullscreen mode.
                  </li>
                  <li className="rounded-2xl border border-white/10 bg-zinc-950/30 p-3">
